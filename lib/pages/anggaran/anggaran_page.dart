                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(
                          builder: (context) {
                            return const CreateAnggaranPage();
                          },
                        ));
                      },
                    ),
...
class MyData extends DataTableSource {
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => EditAnggaranPage(
                            idAnggaran: data[index].reference.id,
  ...
  void deleteData(id) async {
    try {
      await FirebaseFirestore.instance.collection('anggaran').doc(id).delete();
