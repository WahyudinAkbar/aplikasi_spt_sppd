                    ...
                    return FirestoreQueryBuilder(
                      query: snapshot.data?.get('roles') != 'user'
                          ? FirebaseFirestore.instance
                              .collection('spt')
                              .orderBy('no_spt', descending: false)
                          : FirebaseFirestore.instance.collection('spt').where(
                              'userId',
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EditSptPage(
                      idSuratTugas: data[index].reference.id,
                      noSurat: data[index].data()["no_spt"],
                      ...
                      alatTransportasi: data[index].data()["alat_transportasi"],
                    ),
                  ));
            },
          ),
